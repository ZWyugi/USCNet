...
import torch
from src.models.SegPrompt.unet3d.buildingblocks import DoubleConv, ResNetBlock, ResNetBlockSE, create_decoders, create_encoders
from src.models.SegPrompt.unet3d.utils import get_class, number_of_features_per_level
...
if __name__ == '__main__':
    ...
    # binary_map = (output > 0).float()
    # print(torch.unique(binary_map))
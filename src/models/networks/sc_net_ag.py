...
class SC_Net(nn.Module):
    def __init__(self,
        ...
        self.cnn_skip = Conv3dBlock(64, 64, norm_cfg, activation_cfg, kernel_size=3, stride=1, padding=1, weight_std=weight_std)
    ...
    def forward(self, res_encoder_output):
        ...
        skip1_1 = self.cnn_skip1_1(self.transposeconv_skip1_1(self.proj_feat(hidden_states_out[-7])))
        skip1_2 = self.cnn_skip1_2(self.transposeconv_skip1_2(skip1_1))

        #ag2
        ag2_cnn1 = self.ag_cnn2(out1)
        ag2_cnn2 = self.ag_cnn2(skip1_2)
        ...
        skip0_1 = self.cnn_skip0_1(self.transposeconv_skip0_1(self.proj_feat(hidden_states_out[-10])))
        ...
        skip = self.cnn_skip(res_encoder_output[-4])

        #ag4
        ag4_cnn1 = self.ag_cnn4(out3)
        ag4_cnn2 = self.ag_cnn4(skip)
